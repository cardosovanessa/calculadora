...
public class  MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    // Criando os objetos para poder recuperar os id da activity_main.xml
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        // Definindo os eventos de click em cada componente do tipo button
        ...
        igual.setOnClickListener(new View.OnClickListener() {
            ...
            try {
                // Classe responsável por realizar todos os cálculos
                ...
                if (resultado == (double)result) {
                    // Convertendo o result em string
    ...
    // Método findviewbyid para recuperar os id
    ...
    // Inserindo o método onclick e definindo os casos
    @Override
    public void onClick(View view) {
        switch (view.getId()){ // Recuperando o botão do id que foi clicado
